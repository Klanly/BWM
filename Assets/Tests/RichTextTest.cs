...
public class RichTextTest : MonoBehaviour
{
	...
	void Start()
	{
		...
		t.AddXml("<color value='red'>彩色</color>文字");
		...
		t.AddXml("<p><b>粗体\t<i>粗体斜体</i>\t<u>粗体下划线</u></b>\t<s>非粗体的删除线</s></p>");
		t.AddXml("simple text support<p>text<p>text</p></p>");
		t.AddText("A");
		t.AddText("B");
		t.AddText("C");
		t.AddText("D");
		t.AddXml("\t<a href=\"a test\">A TEST</a><br/>");
		t.AddXml("<p><color value='black'>image" +
			...
			"</color></p>");
		t.AddXml("begin1<br/>end1");
		t.AddXml("begin2\nend2");
		t.AddSprite("Atlases/SkillIcon", "1000");
		t.AddXml("begin3<br/>end3");
