...
public class RichTextTest : MonoBehaviour
{
	...
	void Start()
	{
		...
		uiRichText.AddXml("<n>text\ntext</n>");
		uiRichText.AddSprite("Atlases/SkillIcon", "1000");
		uiRichText.AddText("\t[eeee00]党的十八大以来，习主席以实现中国梦、强军梦为核心，鲜明提出了一系列治国理政强军的重大战略思想，为全党全军全国人民团结奋斗、早日实现中华民族伟大复兴提供了思想和理论指南。对空军来说，深入学习贯彻习主席系列重要讲话精神特别是关于国防和军队建设重要论述，就是要以党在新形势下的强军目标为统领，积极适应军事斗争特别是海上方向军事斗争形势任务的发展变化，不断提高空军部队能打仗、打胜仗能力，确保有效履行肩负的使命任务。[-]");
